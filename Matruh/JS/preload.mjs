...
export function preload(){
    ...
    types.map.forEach(map=>{
        graphics.load.map.push(map.term.map(term=>loadImage(`${root}Matruh/Assets/map/${term}.png`)))
    ...
    graphics.load.water=loadBytes(`${root}Matruh/Assets/data/water.bin`)
    graphics.load.fortifications=loadBytes(`${root}Matruh/Assets/data/fortifications.bin`)
}
